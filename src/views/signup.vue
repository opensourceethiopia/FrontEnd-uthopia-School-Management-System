        ...
        <v-form v-model="valid">
          <v-container grid-list-xl light>
            ...
            <v-layout wrap>
              ...
              <v-flex xs12 md8 lg8 class="mx-auto">
                <v-card>
                  <v-img v-if="imageDesplay" :src="imageurl" height="300" class="grey darken-4"></v-img>
                </v-card>
              </v-flex>
              <input
                type="file"
              ...
              <v-flex xs12 md6>
                <v-select v-model="sex" :items="['male','female']" label="Gender" solo></v-select>
              </v-flex>
            </v-layout>
            <h2>STATUS</h2>
            <v-layout wrap>
              <v-flex xs12 md6>
                <v-select :items="items" v-model="Grade" label="Grade"></v-select>
              </v-flex>
...
export default Vue.extend({
  data() {
    return {
      ...
      relation: ["mother", "father", "sister", "brother", "uncle", "aunt"],
      Section: null,
